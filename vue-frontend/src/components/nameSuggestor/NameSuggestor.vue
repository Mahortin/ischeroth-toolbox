      ...
      <ul v-else>
        ...
        <div class="row">
          <div class="custom-column">
            <img alt="Ischeroth logo" class="logo" src="../../assets/gender-transgender.svg" width="75" height="75" />
            <h2>Diverse</h2>
          ...
          <div class="custom-column">
            <img alt="Ischeroth logo" class="logo" src="../../assets/gender-male.svg" width="75" height="75" />
            <h2>Male</h2>
